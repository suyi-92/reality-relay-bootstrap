...
write_config() {
  local project_dir="$1" server_alias="$2" server_ip_ipv4="$3" server_ip_ipv6="$4" ssh_port="$5" admin_user="$6" admin_pubkey="$7" direct_port="$8" enable_subscription_server="$9" subscription_port="${10}" home_port_start="${11}" home_port_end="${12}"
...
main() {
  ...
  local server_alias server_ip_ipv4 server_ip_ipv6 ssh_port admin_user admin_pubkey direct_port enable_subscription_server subscription_port home_port_start home_port_end
